...
public class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingWithError_displaysMessageErrorAndStopsLoading() {
        let (sut, view) = makeSUT()
    ...
    func test_didFinishLoadingWithMapperError_displaysMessageErrorAndStopsLoading() {
        let (sut, view) = makeSUT(mapper: { resource in
            throw anyNSError()
        })
    ...
    private func makeSUT(
        ...
        let view = ViewSpy()
        let sut = SUT(resouceView: view,loadingView: view,errorView: view,mapper: mapper)
    ...
    private class ViewSpy: ResourceView, ResourceLoadingView,ResourceErrorView {
        ...
        typealias ResouceViewModel = String
